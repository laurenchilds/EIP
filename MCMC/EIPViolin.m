...
M1 = BestModel1params;
M2 = Model2params;
load('EIP_BestModel1_GamEst.mat')
M3 = EIP_BestModel1_Gam;
N = BestModel1';

% sigmaE muE f tb k mu0

files = {'ExpG.mat','ExpAD.mat','ExpH.mat','ExpBE.mat','ExpI.mat','ExpCF_all.mat'};
jit = -0.25;
for j = 1:6
load(files{j})
burnin = 50001;
sigE = param(burnin:end,1);
muE = param(burnin:end,2);
f = param(burnin:end,3);
tb = param(burnin:end,4);
k = param(burnin:end,5);
muO = param(burnin:end,6);
